...
def test_cli_experiences_ligadas_por_padrao(monkeypatch, tmp_path):
...
def test_cli_no_experiences_desliga(monkeypatch, tmp_path):
    ...
    assert main(["chat", "--session", "s1", "--no-experiences", "login falha 401"]) == ExitCode.OK
