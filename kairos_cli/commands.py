...
COMMANDS: tuple[Command, ...] = (
    ...
    _c(
        "acp",
        "Servidor Agent Client Protocol para editores",
        _sub("status", "Estado da conexão com editores"),
        _sub("help", "Ajuda do protocolo"),
        status=Status.IMPLEMENTED,
        unit="acp-adapter",
    ),
    _c(
    ...
    _c(
        ...
        _sub("start", "Inicia a automação"),
        _sub("status", "Estado da automação"),
        status=Status.IMPLEMENTED,
        unit="plugins",
    ),
    _c(
    ...
    _c(
        "console",
        "Console interativo",
        _sub("start", "Abre o console"),
        _sub("eval", "Avalia uma expressão"),
        status=Status.IMPLEMENTED,
        unit="agents",
    ),
    _c(
    ...
    _c(
        "gui",
        "Aplicativo desktop",
        _sub("start", "Inicia a interface"),
        _sub("status", "Estado da interface"),
        status=Status.IMPLEMENTED,
        unit="agents",
    ),
    _c(
        "hooks",
        "Hooks de plugin",
        _sub("list", "Lista os hooks"),
        _sub("use", "Ativa um hook"),
        status=Status.IMPLEMENTED,
        unit="plugins",
    ),
    _c(
        "import-agent",
        "Importa configuração de outro agente",
        status=Status.IMPLEMENTED,
        unit="plugins",
    ),
    ...
    _c("login", "Autentica num provedor", status=Status.IMPLEMENTED, unit="kairos-cli"),
    _c("logout", "Encerra a autenticação", status=Status.IMPLEMENTED, unit="kairos-cli"),
    _c(
    ...
    _c(
        ...
        _sub(
            "experiences",
            "Gerencia experiências aprendidas (list/add/confirm/reject/invalidate/record)",
        ),
        status=Status.IMPLEMENTED,
        unit="kairos-cli",
    ),
    ...
    _c(
        "pause",
        "Pausa a atividade autônoma",
        _sub("resume", "Retoma a atividade"),
        _sub("status", "Estado da atividade"),
        status=Status.IMPLEMENTED,
        unit="kairos-cli",
    ),
    _c(
    ...
    _c(
        "prompt-size",
        "Tamanho do prompt de sistema",
        _sub("get", "Mostra o tamanho atual"),
        _sub("set", "Define o tamanho"),
        status=Status.IMPLEMENTED,
        unit="agent",
    ),
    _c(
    ...
    _c(
        ...
        _sub("config", "Configura a integração"),
        _sub("status", "Estado da integração"),
        _sub("test", "Testa a conexão"),
        status=Status.IMPLEMENTED,
        unit="providers-gateway",
    ),
    ...
    _c(
        ...
        _sub("list", "Lista os endpoints"),
        _sub("status", "Estado dos endpoints"),
        status=Status.IMPLEMENTED,
        unit="providers-gateway",
    ),
    _c(
    ...
    _c(
        ...
        _sub("config", "Mostra ou grava a configuração do canal"),
        _sub("test", "Testa a conexão com a Bot API"),
