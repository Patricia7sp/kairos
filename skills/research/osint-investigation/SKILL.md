...
author: Kairos (adapted from ShinMegamiBoson/OpenPlanter, MIT)
license: MIT
...
# $KAIROS_OSINT_CACHE/icij/ (default: ~/.cache/kairos-osint/icij/).
...
# Set KAIROS_OSINT_UA=your-app/1.0 (your@email) to identify yourself
