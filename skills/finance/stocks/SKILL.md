...
```
SCRIPT=~/.kairos/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.kairos/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
