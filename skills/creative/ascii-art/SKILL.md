...
```bash
python -m pyfiglet "KAIROS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=KAIROS&font=Slant" | boxes -d stone
```
