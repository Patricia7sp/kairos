...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.kairos/skills/creative/pixel-art/scripts"))
...
```bash
cd ~/.kairos/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Kairos installs package this)
