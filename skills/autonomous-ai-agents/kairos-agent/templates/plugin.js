/**
 * Kairos desktop plugin template. Save as:
 *   <kairos home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <kairos home> is ~/.kairos by default, or ~/.kairos/profiles/<name>
 * when running a named profile (`kairos -p <name>`). Run `kairos doctor` (or
 ...
 * Only these imports resolve: @kairos/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@kairos/plugin-sdk'
