...
Registry of record: `kairos_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Kairos config+state snapshots (CLI)
...
/update                  Update Kairos to latest
