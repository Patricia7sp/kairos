...
related_skills: [claude-code, kairos-agent]
category: autonomous-ai-agents
---
# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Kairos terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Kairos itself, `model.provider: openai-codex` uses Kairos-managed Codex
OAuth from `~/.kairos/auth.json` after `kairos auth add openai-codex`. For the
...
## Kairos Gateway Caveat

When invoking the Codex CLI from a Kairos gateway/service context (for example,
