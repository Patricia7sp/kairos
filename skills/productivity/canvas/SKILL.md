...
4. Name the token (e.g., "Kairos"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${KAIROS_HOME:-~/.kairos}/.env`:
...
```bash
CANVAS="python $KAIROS_HOME/skills/productivity/canvas/scripts/canvas_api.py"
