...
Data file: $KAIROS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KAIROS_HOME = Path(os.environ.get("KAIROS_HOME", Path.home() / ".kairos"))
DATA_DIR = _KAIROS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
