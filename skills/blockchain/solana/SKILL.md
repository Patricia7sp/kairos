...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Kairos
license: MIT
...
Helper script path: ~/.kairos/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.kairos/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.kairos/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.kairos/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.kairos/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.kairos/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.kairos/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
