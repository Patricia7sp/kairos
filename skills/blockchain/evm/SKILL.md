...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Kairos
license: MIT
...
Helper script path: `~/.kairos/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.kairos/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.kairos/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.kairos/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
