...
def _state_dir() -> Path:
    ...
    # Default: $KAIROS_HOME/watcher-state/, falling back to ~/.kairos/watcher-state/.
    kairos_home = os.environ.get("KAIROS_HOME") or str(Path.home() / ".kairos")
    return Path(kairos_home) / "watcher-state"
